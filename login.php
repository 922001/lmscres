...
if($data['password'] === $password) {
    ...
    header("Location:studentfrontpage.php?user_id=".$user['id']."&department=".$data['department']."&semester=".$data['semester'] );
...
header("Location: superadmin_dashboard.php?user_id=".$data['id']);
