...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            ?>
            <li class="item">
                <a href="admin_unitcard.php?user_id=<?php echo $user['id']; ?>&department=MCA&subject_id=<?php echo $subId; ?>&semester=<?php echo $sem; ?>" class="menu-btn">
 ...
 <br>";
  ...
  <div class='card1'>
 <center>
 <a href='admin_video1.php?user_id=$userId&subject_id=$subId&session_id=$sessionName&unit=$unitName'>
